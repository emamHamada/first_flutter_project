...
import '../../../../services/note_services/notification_services.dart';
...
import '../../components_to_use/reused/note_reused/note_task_tile.dart';
    ...
    Get.bottomSheet(
      SingleChildScrollView(
        child: Container(
          ...
          color: Get.isDarkMode ? Colors.indigo.shade900 : Colors.white,
          child: Column(
            children: [
              Flexible(
                child: Container(
              ...
              child: Wrap(
                ...
                children: [
                  ...
                  SvgPicture.asset(
                    ...
                    width: 100,
                    semanticsLabel: "Task",
                    color: Colors.indigo.shade700.withOpacity(.5),
                  ),
                  Padding(
        ...
        IconButton(
          onPressed: () {
            _taskController.taskList.isEmpty
                ...
                snackPosition: SnackPosition.TOP,
                backgroundColor: Colors.white,
                colorText: Colors.pink.shade400,
                icon: const Icon(
                  Icons.flag,
                  size: 25,
                  color: Colors.red,
